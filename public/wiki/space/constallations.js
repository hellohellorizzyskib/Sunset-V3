(() => {
      ...
      async fetch({ request: t }) {
        ...
        try {
          ...
          let r = new w(
            ...
            this,
            e,
            C.includes(t.method.toUpperCase()) ? null : await t.blob()
          );
          if (
            (e.meta.url.protocol === "blob:" &&
              ((r.blob = !0), (r.base = r.url = new URL(r.url.pathname))),
            t.referrer && t.referrer.startsWith(location.origin))
          ) {
            let s = new URL(e.sourceUrl(t.referrer));
            (r.headers.origin ||
              (e.meta.url.origin !== s.origin && t.mode === "cors")) &&
          ...
          let u = await this.bareClient.fetch(b, {
            ...
            o = new v(r, u),
            h = new m(o, null, null);
          if ((this.emit("beforemod", h), h.intercepted)) return h.returnValue;
          for (let s of S) o.headers[s] && delete o.headers[s];
          if (
            (o.headers.location &&
              (o.headers.location = e.rewriteUrl(o.headers.location)),
          ...
          if (
            (o.headers["set-cookie"] &&
              (Promise.resolve(
                e.cookie.setCookies(o.headers["set-cookie"], a, e.meta)
              ).then(() => {
  ...
  `),
              ...
              case "document":
                if (U(e.meta.url, o.headers["content-type"] || "")) {
                  ...
                  if (typeof this.config.inject == "function") {
                    ...
                    (l !== -1 || y !== -1) &&
                      (s = s.slice(0, l) + `${await x}` + s.slice(l));
                  }
          ...
          return (
            ...
            crossOriginIsolated &&
              (o.headers["Cross-Origin-Embedder-Policy"] = "require-corp"),
  ...
  function U(n, t = "") {
    return (
      (f.mime.contentType(t || n.pathname) || "text/html").split(";")[0] ===
      "text/html"
    );
  }
  var m = class {
  ...
  function E(n, t) {
    ...
    return `<!DOCTYPE html><html><head>
      ...
      body { 
          ...
          </head><body style="color: white; background-color: #171717;"><h1>This site can\u2019t be reached</h1><hr /><p><b id="remoteHostname"></b>\u2019s server IP address could not be found.</p><p>Try:</p><ul><li>Verifying you entered the correct address</li><li>Clearing the site data</li><li>Contacting <b id="uvHostname"></b>'s administrator</li><li>Verifying the <a href="https://lightgo.app/bare/" title='Bare server'>Bare server</a> isn't censored</li></ul><button id="reload">Reload</button><hr /><p><i>Ultraviolet v<span id="uvVersion"></span></i></p><script src="${
